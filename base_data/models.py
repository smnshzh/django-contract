...
class EmployeeDetails(models.Model):
    ...
    monthly_base_salary = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="حقوق پایه ماهانه")
    daily_base_salary = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="حقوق پایه روزانه")
    hourly_base_salary = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="حقوق پایه هر ساعت")
    recruitment_bonus = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="حق جذب")
    ...
    food_and_weather_allowance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="بن و خواروبار")
    weather_disability = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="بدی آب و هوا")
    mission_allowance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="حق ماموریت")
    bonus = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="پاداش")
    insured = models.CharField(max_length=10, verbose_name="مشمول بیمه")
    ...
    two_thirds_exemption = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="معافیت دو هفتم")
    seniority = models.IntegerField(verbose_name="سنوات")
    supervisor_allowance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="حق سرپرستی")
    supplementary_insurance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="بیمه تکمیلی")
    unemployment_insurance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="بیمه بیکاری")
    termination_date = models.DateField(verbose_name="تاریخ ترک کار")
    child_number = models.IntegerField(verbose_name="تعداد فرزند")
    cstart = models.DateField(verbose_name="تاریخ شروع قرارداد")
    cend = models.DateField(verbose_name="تاریخ پایان قرارداد")
    ...
    class Meta:
        ...
        unique_together = ['insurance_number', 'employee_id']
